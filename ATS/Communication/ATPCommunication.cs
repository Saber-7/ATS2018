...
namespace ATS
{
    class ATPsCommunication
    {


        public ATPsCommunication(IPEndPoint lEP)
        {
        ...
        public ATPsCommunication(IPEndPoint lEP, BlockingCollection<EPAndBytes> mesQueue)
        {
            socketMain = new Socket(AddressFamily.InterNetwork, SocketType.Dgram, ProtocolType.Udp);
            try
            {
        ...
        BlockingCollection<EPAndBytes> MesQueue;
        ...
        public void ReceiveData(IAsyncResult iar)
        {
            ...
            if (socketMain != null)
            {
                ...
                MesQueue.Add(new EPAndBytes(_REP,receiveDataArray));
